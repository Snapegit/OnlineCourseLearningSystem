...
public class ZaixianjiaoliuEntity<T> implements Serializable {
	 ...
	 * 设置：交流时间
	 */
	public void setJiaoliushijian(Date jiaoliushijian) {
		this.jiaoliushijian = jiaoliushijian;
	}
	/**
	 * 获取：交流时间
	 */
	public Date getJiaoliushijian() {
		return jiaoliushijian;
	}
	/**
	 * 设置：回复内容
	 */
