				...
				<el-row>
					...
					<el-col :span="24">
						<el-form-item label="课件" prop="kejian">
							<uploads
								:disabled="!isAdd||disabledForm.kejian?true:false"
								type="file"
								action="file/upload" 
								tip="请上传课件" 
								:limit="1" 
								style="width: 100%;text-align: left;"
								:fileUrls="form.kejian?form.kejian:''" 
								@change="kejianUploadSuccess">
							</uploads>
						</el-form-item>
					</el-col>
					<el-col :span="24">
...
<script setup>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='kejian'){
					form.value.kejian = row[x];
					disabledForm.value.kejian = true;
					continue;
				}
				if(x=='keshi'){
	...
	const save=()=>{
		...
		if(form.value.kejian!=null) {
			form.value.kejian = form.value.kejian.replace(new RegExp(context?.$config.url,"g"),"");
		}
