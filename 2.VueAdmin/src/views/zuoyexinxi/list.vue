	...
	<div>
		<div class="app-contain">
			...
			<el-table
				...
				<el-table-column label="作业附件" :resizable='true' :sortable='true' align="left" header-align="left">
					<template #default="scope">
				...
				<el-table-column label="操作" width="300" :resizable='true' :sortable='true' align="left" header-align="left">
					<template #default="scope">
						...
						<el-button v-if="btnAuth('zuoyexinxi','提交')" type="success" @click="tijiaozuoyeCrossAddOrUpdateHandler(scope.row,'cross','','','')">提交</el-button>
					</template>
				</el-table-column>
			</el-table>
			<el-pagination 
...
<script setup>
    ...
    const tijiaozuoyeCrossAddOrUpdateHandler = (row,type,crossOptAudit,statusColumnName,tips,statusColumnValue) => {
