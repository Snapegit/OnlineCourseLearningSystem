	...
	<div class="app-contain" :style='{"padding":"20px 20px","margin":"20px auto 40px","alignItems":"flex-start","flexWrap":"wrap","background":"#fff","display":"flex","width":"1200px","position":"relative","justifyContent":"space-between"}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="btn_view">
					<el-button class="cross_btn" v-if="btnFrontAuth(tableName,'进度')" @click="xuexijinduonAcross('进度','xuexijindu','','','')" type="warning">进度</el-button>
...
<script setup>
	...
	const xuexijinduonAcross = (btnType,table,crossOptAudit,statusColumnName,tips,statusColumnValue) => {
