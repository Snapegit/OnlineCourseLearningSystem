			...
			<el-row>
				...
				<el-col :span="24">
					<el-form-item label="进度" prop="jindu">
						<el-input class="list_inp" v-model="form.jindu" placeholder="进度"
							 type="text" 							:readonly="!isAdd||disabledForm.jindu?true:false" />
					</el-form-item>
				</el-col>
	...
	const init = (formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null) => {
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='jindu'){
					form.value.jindu = row[x];
					disabledForm.value.jindu = true;
					continue;
				}
				if(x=='gengxinshijian'){
