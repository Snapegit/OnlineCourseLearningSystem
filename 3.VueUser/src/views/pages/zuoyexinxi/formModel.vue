	...
	<div class="app-contain" :style='{"padding":"20px 20px","margin":"20px auto 40px","alignItems":"flex-start","flexWrap":"wrap","background":"#fff","display":"flex","width":"1200px","position":"relative","justifyContent":"space-between"}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">作业附件</div>
					<div class="info_text">
						<el-button class="info_down" v-if="detail.zuoyefujian" @click="downClick(detail.zuoyefujian)">点击下载</el-button>
						<el-button class="info_undown" v-else>暂无</el-button>
					</div>
				</div>
				<div class="btn_view">
					<el-button class="cross_btn" v-if="btnFrontAuth(tableName,'提交')" @click="tijiaozuoyeonAcross('提交','tijiaozuoye','','','')" type="warning">提交</el-button>
...
<script setup>
	...
	const tijiaozuoyeonAcross = (btnType,table,crossOptAudit,statusColumnName,tips,statusColumnValue) => {
